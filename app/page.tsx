  ...
  return (
    <div className="mt-12 text-zinc-900 max-w-3xl mx-auto mb-12">
      ...
      <section>
        ...
        <p className="text-base text-zinc-800 mb-5 leading-snug text-justify">
          I am interested in using principles from <span className="font-medium">classical statistics</span> to inform robust <span className="font-medium">data science</span> and <span className="font-medium">machine learning</span> methodology. My applied interests lie in <span className="font-medium">human genetics</span> (i.e. demographic inference, evolutionary genetics, trait genetics) and <span className="font-medium">management science</span> (i.e. sequential and adaptive inference, experimental design, quantitative marketing).
        </p>
        <p className="text-base text-zinc-800 mb-5 leading-snug text-justify">
